        ...
        <div class="row justify-content-center">
            <div class="col col-8">
                <form method="post">
                    ...
                    <div class="mb-3">
                        <label for="exampleInputPassword2" class="form-label">Password_verify</label>
                        <input type="password" name="password_verify" class="form-control" id="exampleInputPassword2">
                    </div>
